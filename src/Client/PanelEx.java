...
/** Since DrawingPanel cannot extend UnicastRemoteObject (it already extends a class), this class
 * handles the RMI side of things which DrawingPanel would have used. */
